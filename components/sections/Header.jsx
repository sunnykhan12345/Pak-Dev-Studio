...
export default function Header() {
  return (
    <header className="fixed inset-x-0 top-7 z-50 px-4 pointer-events-none">
      ...
      >
        <div className="mx-auto flex h-[72px] items-center justify-between gap-3 rounded-[60px] border border-white/10 bg-white/5 px-4 shadow-[0_18px_70px_rgba(0,0,0,0.35)] backdrop-blur-2xl dark:bg-[#222325]/70 light-header">
          <Link
            href="#home"
